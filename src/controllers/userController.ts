...
export async function getUserByIdRoute(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
...
export async function deleteUserRoute(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
...
export async function updateUserRoute(request: FastifyRequest<{ Params: { id: string }, Body: Partial<CadastreUser> }>, reply: FastifyReply) {
    try {
